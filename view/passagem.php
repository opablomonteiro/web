	...
	<header id="header" class="header-one">
                  ...
                  <div class="row">
                     <div class="col-xs-12">
                        <div class="banner-heading">
                           <h1 class="banner-title" >Passagem</h1>
                        </div>
                     </div>
                  </div>
               </div>
		...
		<section id="main-container" class="main-container">
			...
			<div class="container">
			 ...
			 <div class="row">
				<div class="col-md-8">
				   <img src="images/compra_paris.jpg" alt="ops">
				</div>
	
				<div class="col-md-4">
	
				   <h3 class="column-title mrt-0">Passagem #098293</h3>
				   
	
				   <ul class="project-info unstyled">
                    
                    <li>
                        <div class="project-info-label">Nome do passageiro</div>
                        <div class="project-info-content">Carlos Alberto.</div>
                     </li>

                    <li>
                        <div class="project-info-label">Origem</div>
                        <div class="project-info-content">Salvador,Aeroporto Internacional Dep. Luís Eduardo Magalhães.</div>
                     </li>

                     <li>
                        <div class="project-info-label">Destino</div>
                        <div class="project-info-content">Paris,Aeroporto Charles de Gaulle.</div>
                     </li>

                      <li>
						 <div class="project-info-label">Data</div>
						 <div class="project-info-content">25/08/2020 as 20hrs.</div>
					  </li>
				
					  <li>
						 <div class="project-info-label">Número do voo</div>
						 <div class="project-info-content">854760</div>
                      </li>

                      <li>
                        <div class="project-info-label">Status</div>
                        <div class="project-info-content">Primeira classe.</div>
                     </li>
                      
                      <li>
                        <div class="project-info-label">Check-in</div>
                        <div class="project-info-content">Não realizado.</div>
                     </li>
