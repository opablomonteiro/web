            ...
            <div class="row">
               <div class="col-xs-12">
                  <div class="banner-heading">
                     <h1 class="banner-title" >Reclamação sobre bagagem</h1>
                     <ol class="breadcrumb">
                        <li>Fazer reclamação</li>
                        <li>Consultar reclamação</li>
                     </ol>
                  </div>
               </div>
            </div>
      ...
      <div class="container">
         <div class="row">
            ...
            <div class="col-md-4">
               <div class="ts-service-box">
                  <div class="ts-service-image-wrapper">
                     <img class="img-responsive" src="images/reclama_bag.jpg" alt="">
                  </div>
                  <div class="ts-service-box-img pull-left">
                     <img src="images/cria_icon.png" alt="" />
                  </div>
                  <div class="ts-service-info">
                     <h3 class="service-box-title"><a href="registrarreclamacao.php">Criar Reclamação</a></h3>
                     <p>Crie uma nova reclamação.</p>
            ...
            <div class="col-md-4">
               <div class="ts-service-box">
                  <div class="ts-service-image-wrapper">
                        <img class="img-responsive" src="images/consu_bag.jpg" alt="">
                  </div>
                  <div class="ts-service-box-img pull-left">
                     <img src="images/consu_icon.png" alt="" />
                  </div>
                  <div class="ts-service-info">
                     <h3 class="service-box-title"><a href="consultareclamacao.php">Consultar reclamação</a></h3>
                     <p>Consulte o andamente de uma reclamação.</p>
