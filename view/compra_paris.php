	    ...
	    <div class="container">
         ...
         <div class="row">
            ...
            <div class="col-md-4">
               ...
               <h3 class="column-title mrt-0">Paris</h3>
               ...
               <ul class="project-info unstyled">
                  <li>
                     ...
                     <div class="project-info-content">20/08/2020 as 20hrs.</div>
                  </li>
                  <li>
                     <div class="project-info-label">Preço</div>
                     <div class="project-info-content">R$1500,00</div>
                  </li>
                  <li>
                     <div class="project-info-label">Número do voo</div>
                     <div class="project-info-content">798932</div>
                  </li>
                  <li>
                     <div class="project-info-label">Preço primeira classe</div>
                     <div class="project-info-content">R$2100,00</div>
                  </li>
                  <li>
