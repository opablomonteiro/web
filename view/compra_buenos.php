...
<body>
   ...
   <section id="main-container" class="main-container">
	    ...
	    <div class="container">
         ...
         <div class="row">
            <div class="col-md-8">
               <img src="images/compra_buenos.jpg" alt="ops">
            </div>

            <div class="col-md-4">

               <h3 class="column-title mrt-0">Buenos Aires</h3>
               <p>Buenos Aires é a capital cosmopolita da Argentina. Seu centro é a Praça de Maio, com imponentes edifícios do século 19, como a Casa Rosada, o emblemático palácio presidencial com sacadas.</p>
               ...
               <ul class="project-info unstyled">
                  ...
                  <li>
                     ...
                     <div class="project-info-content">R$1000,00</div>
                  </li>
                  <li>
                     <div class="project-info-label">Número do voo</div>
                     <div class="project-info-content">657727</div>
                  </li>
                  <li>
                     <div class="project-info-label">Preço primeira classe</div>
                     <div class="project-info-content">R$1400,00</div>
                  </li>
                  <li>
