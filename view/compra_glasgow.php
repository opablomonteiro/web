	...
	<header id="header" class="header-one">
		...
		<section id="main-container" class="main-container">
			...
			<div class="container">
			 ...
			 <div class="row">
				<div class="col-md-8">
				   <img src="images/compra_glasgow.jpg" alt="ops">
				</div>
	
				<div class="col-md-4">
	
				   <h3 class="column-title mrt-0">Glasgow</h3>
				   <p>Glasgow é uma cidade portuária no rio Clyde, nas Terras Baixas ocidentais da Escócia. É famosa por sua arquitetura vitoriana e art nouveau, que representa um rico legado de prosperidade entre os séculos 18 e 20, quando a cidade foi impulsionada pelo comércio e pela construção naval.</p>
	
				   <ul class="project-info unstyled">
					  <li>
						 <div class="project-info-label">Data</div>
						 <div class="project-info-content">25/08/2020 as 15hrs.</div>
					  </li>
					  <li>
						 <div class="project-info-label">Preço</div>
						 <div class="project-info-content">R$2000,00</div>
					  </li>
					  <li>
						 <div class="project-info-label">Número do voo</div>
						 <div class="project-info-content">557467</div>
					  </li>
					  <li>
						 <div class="project-info-label">Preço primeira classe</div>
						 <div class="project-info-content">R$2800,00</div>
					  </li>
					  <li>
