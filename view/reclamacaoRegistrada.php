...
<div class="container_report">
    ...
    <div class="container_in_report">
        <label for="report">ID Reclamação</label>
        <p id="report">#12356</p>

        <label for="passagem">ID Passagem</label>
        <p id="passagem">#75693</p>

        <label for="data_report">Data da Reclamação</label>
        <p id="data_report">12/12/2019</p>

        <label for="description">Descrição</label>
        <p id="description">A bagagem em questão foi avariada externamente e internamente, exigo total reparo por parte da empresa.</p>
