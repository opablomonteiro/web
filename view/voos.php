...
<head>
    ...
    var filtro2 = document.getElementById('filtro-destino');
...
<body>
   ...
   <div id="banner-area" class="banner-area" style="background-image:url(images/voo.jpg)">
      <div class="banner-text">
         <div class="container">
            <div class="row">
               <div class="col-xs-12">
                  <div class="banner-heading">
                     <h1 class="banner-title">Pesquise seu voo!</h1>
   ...
   <section id="main-container" class="main-container">
    ...
    <thead>
        <tr id = "cabe_table">
            <th class = "thtable"><div>Origem</div><div><input id="filtro-nome" placeholder = "Digite a origem.."/></div></th>
			<th class = "thtable"><div>Destino</div><div><input id="filtro-destino" placeholder = "Digite o Destino.."/></div></th>
			<th class = "thtable"><div>Data</div></th>
			<th class = "thtable"><div>Número</div></th>
			<th class = "thtable"><div>Preço</div></th>
        </tr>
    </thead>
    <tbody>
        <tr>
            <td><a href = "compra_paris.php">Salvador</a></td>
            <td><a href = "compra_paris.php">Paris - França</a></td>
            <td><a href = "compra_paris.php">20/08/2020</a></td>
			<td><a href = "compra_paris.php">798932</a></td>
			<td><a href = "compra_paris.php">R$1500,00</a></td>
        </tr>
        <tr>
			<td><a href = "compra_tokyo.php">Salvador</a></td>
            <td><a href = "compra_tokyo.php">Tokyo - Japão</a></td>
            <td><a href = "compra_tokyo.php">22/08/2020</a></td>
            <td><a href = "compra_tokyo.php">252690</a></td>
            <td><a href = "compra_tokyo.php">R$2500,00</a></td>
        </tr>
        <tr>
			<td><a href = "compra_buenos.php">Salvador</a></td>
            <td><a href = "compra_buenos.php">Buenos Aires - Argentina</a></td>
            <td><a href = "compra_buenos.php">25/08/2020</a></td>
            <td><a href = "compra_buenos.php">657727</a></td>
            <td><a href = "compra_buenos.php">R$1000,00</a></td>
        </tr>
		<tr>
			<td><a href = "compra_sp.php">Salvador</a></td>
            <td><a href = "compra_sp.php">São Paulo - Brasil</a></td>
            <td><a href = "compra_sp.php">25/08/2020</a></td>
            <td><a href = "compra_sp.php">167427</a></td>
            <td><a href = "compra_sp.php">R$300,00</a></td>
        </tr>
		<tr>
            <td><a href = "compra_glasgow.php">Salvador</a></td>
            <td><a href = "compra_glasgow.php">Glasgow - Escócia</a></td>
            <td><a href = "compra_glasgow.php">25/08/2020</a></td>
            <td><a href = "compra_glasgow.php">557467</a></td>
            <td><a href = "compra_glasgow.php">R$2000,00</a></td>
        </tr>
		<tr>
            <td><a href = "compra_paris2.php">Salvador</a></td>
            <td><a href = "compra_paris2.php">Paris - França</a></td>
            <td><a href = "compra_paris2.php">29/08/2020</a></td></td>
            <td><a href = "compra_paris2.php">854760</a></td>
            <td><a href = "compra_paris2.php">R$1400,00</a></td>
        </tr>
   </tbody>
   </table>
