...
<body>
   ...
   <section id="main-container" class="main-container">
	    ...
	    <div class="container">
         ...
         <div class="row">
            <div class="col-md-8">
               <img src="images/compra_tokyo.jpg" alt="ops">
            </div>

            <div class="col-md-4">

               <h3 class="column-title mrt-0">Tokyo</h3>
               <p>Tóquio, a movimentada capital do Japão, combina o estilo ultramoderno com o tradicional, desde arranha-céus iluminados por neon a templos históricos.</p>

               <ul class="project-info unstyled">
                  <li>
                     <div class="project-info-label">Data</div>
                     <div class="project-info-content">22/08/2020 as 20hrs.</div>
                  </li>
                  <li>
                     <div class="project-info-label">Preço</div>
                     <div class="project-info-content">R$2500,00</div>
                  </li>
                  <li>
                     <div class="project-info-label">Número do voo</div>
                     <div class="project-info-content">252690</div>
                  </li>
                  <li>
                     <div class="project-info-label">Preço primeira classe</div>
                     <div class="project-info-content">R$3500,00</div>
                  </li>
                  <li>
