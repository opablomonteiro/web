        ...
        <div id="banner-area" class="banner-area" style="background-image:url(images/serv.jpg)">
         ...
         <section id="secdel">
            <div class="container3">
             ...
             <form action="alterarPassagem.html" name="select_alterar_passagem" method="POST" action="url para script aqui">
                
                <label for="passagens_al">Passagem:</label>
                 <select id="passagens_al">
                    <option value="1x">Passagem:21947</option>
                    <option value="2x">Passagem:64978</option>
                    <option value="3x">Passagem:30887</option>
                 </select><br>

                 <input id="btn-alterar" type="submit" type="button" class="button" value="Alterar"  />
