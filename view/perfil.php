             ...
             <div class="tab-pane" id="passagens">
               ...
               <hr>
                            ...
                            <table class="table" id="pass_trip1">
                                ...
                                <?php
         $quant = count($passagem);
         for($i=0;$i<$quant;$i++){ ?>
             <tr>
               <td> <?php echo $passagem[$i][0];?></td>
               <td> <?php echo $passagem[$i][1];?></td>
               <td> <?php echo $passagem[$i][2];?></td>
             </tr>
          <?php }    
         ?>
             ...
             <div class="tab-pane" id="reclamacoes">
                  ...
                  <hr>
                    ...
                    <table class="table">
                        ...
                        <tr>
                            <td><a href="reclamacaoRegistrada.php">#759632</a></td>
                            <td><a href="reclamacaoRegistrada.php">12563</a></td>
                            <td><a href="reclamacaoRegistrada.php">12/11/2019</a></td>
