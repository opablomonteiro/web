...
<html class="cadastro" lang="pt-br">
	...
	<body class="cadastro">
        ...
        <div class="container3">
	     ...
	     <form name="login_cliente" method="post" action="..\controller\controller.php">
                <label for="nomec">Nome:</label>
                <input name="nome" id="nomec" required="required" type="text" placeholder="Informe seu Nome para acessar"  maxlength="60"/>
            
                <label for="psw">Senha:</label>
				<input name="psw" id="pwd" required="required" type="password" placeholder="Digite sua senha.." size="30"/>
		   
				<input type="hidden" name="acao" value="login" id="acao">
				
                <input id = "login" type="submit" type="button" class="button" value="Fazer Login"/>
				<a name = "cadastrar" id = "btn-consultar" class="btn btn-primary" target="_blank" href="cadastro.php">Cadastrar</a>
